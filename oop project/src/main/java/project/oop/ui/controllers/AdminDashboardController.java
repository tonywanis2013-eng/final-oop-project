...
public class AdminDashboardController {
    ...
    public void initialize() {
        ...
        if (staff != null) staffNameLabel.setText(staff.getUsername());
    ...
    @FXML public void goToManageRooms() {
        SceneNavigator.navigateTo("ManageRooms.fxml");
    }

    private void highlight(Button active) {
        String normal = "-fx-background-color: transparent; -fx-text-fill: #B5D4F4; " +
                "-fx-font-size: 13px; -fx-alignment: CENTER_LEFT; -fx-padding: 12 20 12 20; " +
                "-fx-border-width: 0; -fx-background-radius: 0; -fx-cursor: hand;";
        String activeStyle = "-fx-background-color: rgba(255,255,255,0.18); -fx-text-fill: white; " +
                "-fx-font-size: 13px; -fx-alignment: CENTER_LEFT; -fx-padding: 12 20 12 20; " +
                "-fx-border-width: 0; -fx-background-radius: 0; -fx-cursor: hand; -fx-font-weight: bold;";
